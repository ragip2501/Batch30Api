...
public class GetRequest10 extends DummyTestBase {
 ...
 /*
    ...
    url ine bir istek gönderildiğinde Dönen response un Status kodunun 200,
 ...
 */
   ...
   @Test
    public void test(){
      ...
      //Groovy dili javanın alt dilidir.Biz dil yardımı ie loop kullanmaddan
      //gelen responsedeki değrleri bir şarta bağlı olarak listeye yazdırabiliyoruz
